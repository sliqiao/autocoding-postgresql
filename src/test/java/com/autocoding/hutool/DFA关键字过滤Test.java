...
public class DFA关键字过滤Test {
	...
	static {
		...
		tree.addWord("国家危急");
		tree.addWord("国家危急");
		tree.addWord("现在天下分为三国，指蜀汉国力薄弱，处境艰难。这确实是国家危急存亡的时期啊");
		tree.addWord("现在天下分为三国，指蜀汉国力薄弱，处境艰难。这确实是国家危急存亡的时期啊1");
		tree.addWord("现在天下分为三国，指蜀汉国力薄弱，处境艰难。这确实是国家危急存亡的时期啊2");
		tree.addWord("现在天下分为三国，指蜀汉国力薄弱，处境艰难。这确实是国家危急存亡的时期啊3");
	}

...
public class SqlCreatorBuilder extends BaseCodeBuilder {

	public SqlCreatorBuilder(Project project) {
		super(project);
		super.fileoutputPath = super.project.getServiceImplPath() + super.entity.getEntityName() + "SqlCreator.java";
